* Ch10_3_1a.sas
* Adding graphics;
* import full size GIF files - which are way way too big.;
...
%do i = 1 %to &regcnt;
   ...
   * Images produced using GIF are too big to import into a graph;
   goptions dev=gif
            gsfname=propie;
...
ods html path="&path\results"
         body="ch10_3_1a.html"
         style=default;
ods pdf  file="&path\results\ch10_3_1a.pdf"
         style=minimal;
ods rtf  file="&path\results\ch10_3_1a.rtf"
         style=rtf;

title1 'Interfacing with REPORT';
title2 'Adding Graphics';
title3 'Full Size GIF Files';

proc report data=clinics nofs split='*';
