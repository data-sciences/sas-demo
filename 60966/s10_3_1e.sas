...
%do i = 1 %to &regcnt;
   ...
   * &&REG&I resolves to the region name;
   filename propie "&path\results\&&reg&i...jpeg";
   * Define the graphics device;
   goptions dev=jpeg
            xpixels=61 ypixels=35
            gsfname=propie;
...
ods html path="&path\results"
         body="ch10_3_1e.html"
         style=default;
ods pdf  file="&path\results\ch10_3_1e.pdf"
         style=minimal;
ods rtf  file="&path\results\ch10_3_1e.rtf"
         style=rtf;
