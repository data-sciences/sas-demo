...
/*=== JES\sample_code\ch_7\duality_1.sas ===*/
TITLE1 "Delay vs Resistance - Duality - Q4 2008";
...
PROC GPLOT DATA=JES.Results_Q4(WHERE=(Vendor="Duality"));
	PLOT Delay*Resistance=Mon / NAME="Dual_1"
