...
/*=== JES\sample_code\ch_7\empirical_1.sas ===*/
TITLE1 "Delay vs Resistance - Empirical - Q4 2008";
...
PROC GPLOT DATA=JES.Results_Q4(WHERE=(Vendor="Empirical"));
	PLOT Delay*Resistance=Mon / NAME="Emp_1"
