...
/*--Create custom style with smaller fonts for axis values--*/
proc template;
   define style styles.SurvivalPlot;
...
/*--Create graph--*/
ods listing style=styles.SurvivalPlot image_dpi=200;
ods graphics / reset width=6in height=4in imagename='Fig12_4_SurvivalPlot_V92';
...
proc sgplot data=SurvivalPlotData;
  ...
  /*--Use step plot for the survival curves--*/
  step x=time y=survival / group=stratum lineattrs=(pattern=solid) name='survival';
