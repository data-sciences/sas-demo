...
*/                            Second Edition                          */                                                                                                                      
 ...
 /*     Comments for Paul Allison                                     */
 /*                                                                   */
 /*-------------------------------------------------------------------*/



  The example data for Survival Analysis Using SAS: A Practical Guide, 
  Second Edition is available in a zip file.

  The example data listed in Appendix A is located at 
  http://support.sas.com/publishing/bbu/zip/61339.zip 
