...
The example code and data for <book title> are available in a zip file.

To access the example code and data, copy and paste the following url into 
your browser and press the ENTER key.

http://support.sas.com/publishing/bbu/zip/63100.zip
